...
{
    public partial class NorthwindConsole_31_mdoContext : DbContext
    {
        public NorthwindConsole_31_mdoContext()
        {
        }

        public NorthwindConsole_31_mdoContext(DbContextOptions<NorthwindConsole_31_mdoContext> options)
            : base(options)
        {
        }
